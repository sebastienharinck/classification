...
urlpatterns = [
    ...
    path('<int:pk>/statistics/', views.BucketStatisticsView.as_view(), name='statistics'),
    path('<int:pk>/statistics/download/', views.BucketStatisticsPandasDataFrameFile.as_view(), name='statistics_download'),
